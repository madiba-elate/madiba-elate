...
**IA & ML**  
`PyTorch` `Hugging Face` `LangChain` `LangGraph` `RAG` `LoRA/QLoRA` `Ollama` `OpenRouter` `Nemotron-3-Ultra`

**Cloud & Infra**  
`Docker` `Kubernetes` `Terraform` `Cloudflare` `Tailscale` `Linux` `systemd` `NixOS`
